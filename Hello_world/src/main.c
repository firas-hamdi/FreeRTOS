/**
  ...
  * @brief   Disable preemptive scheduling policy and use Co-operative scheduling
  * Co-operative scheduling relies on each task running until it is told to give
  * up the CPU
  ******************************************************************************
*/
...
//#define SEMI_HOSTING	/*Uncomment to activate SEMI_HOSTING
...
void vTask1_handler(void *params)
{
	while(1)
	{
		if(UART_ACCESS_KEY)
		{
			...
			//Trigger Manual context switching
			taskYIELD();
		}
	}
}
